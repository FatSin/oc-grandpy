...
def parser():
	...
	stop +=["aller","veux","voudrais","trouve","savoir","faut","cherche","connais","connaissais","connaître","adresse","l'adresse","grandpy","est-ce","!","?",".","salut","bonjour",",","dis"]
	...
	if ( "extract" in content_wiki.keys()):
